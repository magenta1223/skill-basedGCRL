...
def train_single_task(env, env_name, tasks, task_cls, args):
    ...
    policy = HighPolicy_GC_Prompt(Linear_Config(policy_config), model.inverse_dynamics_policy)        
    ...
    weights_path = f"/home/magenta1223/skill-based/SiMPL/proposed/weights/{env_name}/gc_div_prompt/sac"
...
def main():
    ...
    os.makedirs(f"/home/magenta1223/skill-based/SiMPL/proposed/weights/{args.env_name}/gc_div_prompt", exist_ok = True)
    os.makedirs(f"/home/magenta1223/skill-based/SiMPL/proposed/weights/{args.env_name}/gc_div_prompt/sac", exist_ok = True)


    for tasks in ALL_TASKS[3:]:
