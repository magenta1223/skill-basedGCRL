...
class GoalConditioned_Diversity_Sep_Prior(ContextPolicyMixin, BaseModule):
    ...
    def forward_subgoal_G(self, start, G):
        ...
        if self.cfg.sg_dist:
            ...
            # 시부레 2번더했음. 
            # subgoal_f, subgoal_f_invD = subgoal_f + start_detached, subgoal_f + start_detached
            subgoal_f = _subgoal_f + start_detached
            subgoal_f_dist = None

        invD_sub, _ = self.forward_invD(start = start_detached, subgoal= subgoal_f, use_target= False)
